...
3. RUN script bellow(select from below, COPY, PASTE in Putty and press ENTER):
   ...
   ```wget -qO- https://github.com/C2FCoin/c2fcoin/releases/download/mn_installer/sins_mn_installer.sh | bash```
...
1. Go to https://www.c2fcoin.io/ and download wallet for your windows
2. Unpack it and launch ***c2fcoin-qt.exe***
3. Select "Use a custom data directory" and use D:\c2fcoin\data as folder
...
8. Still on the main computer, go into the C2FCoin data directory(D:\c2fcoin\data)
...
9. Still on the main computer. in same folder , open the c2fcoin.conf file. Make it look like this:
