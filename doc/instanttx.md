...
This mechanism has been integrated into Bitcore-Node-C2FCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/C2FCoin-Project/insight-api-c2fcoin#web-socket-api](https://github.com/C2FCoin-Project/insight-api-c2fcoin#web-socket-api) 
* API: [https://github.com/C2FCoin-Project/insight-api-c2fcoin#instantsend-transactions](https://github.com/C2FCoin-Project/insight-api-c2fcoin#instantsend-transactions) 
...
By default, the C2FCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the C2FCoin Core daemon:
